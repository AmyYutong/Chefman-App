...
struct UploadRecipeView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .overlay {
                if isUploading && !showSuccessBanner {
                    uploadingOverlay
                }
            }
            .overlay(alignment: .top) {
                if showSuccessBanner {
                    SuccessBannerView(message: successMessage)
                        ...
                        .zIndex(1000) // Ensure success banner is on top
                }
            }
    ...
    private func uploadRecipe() {
        ...
        Task {
            do {
                ...
                // First, hide the uploading overlay
                await MainActor.run {
                    isUploading = false
                }
                
                // Then show success banner after a brief delay
