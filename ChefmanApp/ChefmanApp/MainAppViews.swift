    ...
    var body: some View {
        NavigationStack {
            ...
            .onChange(of: library.recipes) {
                print("🔄 library.recipes changed, reloading random recipes")
                loadRandomRecipes()
            }
        ...
        NavigationStack {
            Form {
                Section(header: Text("Diet Requirements")) {
                    ...
                    Text("Separate multiple diets with commas or line breaks.")
                        .font(.caption)
                        .foregroundColor(.secondary)
                }
                
                Section(header: Text("Available Ingredients")) {
                    TextField("List ingredients on hand, e.g., chicken, tomato", text: $ingredientsInput, axis: .vertical)
                        .textInputAutocapitalization(.never)
                        .disableAutocorrection(true)
                    Text("Use English ingredient names for better matching.")
                        .font(.caption)
                        .foregroundColor(.secondary)
                }
                ...
                Section(header: Text("Results")) {
                    if isLoading {
                        ...
                        Text("Enter your criteria and tap “Find Matches” to get personalized recipes.")
                            .foregroundColor(.secondary)
                    } else {
